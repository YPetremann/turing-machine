    ...
    <form ref={formRef} className="col-span-full row-span-full w-170 h-231 p-4 flex flex-col bg-white justify-between">
      <div className="flex flex-row items-start justify-between">
        <div className="grid grid-cols-3 justify-items-center">
          <Insert text=" :T ">
            <Icon icon="uim:triangle" className="text-4xl mb-1 text-blue-400"/>
          </Insert>
          <Insert text=" :R ">
            <Icon icon="uim:square" className="text-4xl mb-1 text-yellow-400"/>
          </Insert>
          <Insert text=" :C ">
            <Icon icon="uim:circle" className="text-4xl mb-1 text-purple-800"/>
          </Insert>
        ...
        <div className="grid grid-cols-6 justify-items-center">
          <Icon icon="mdi:letter-a" className="text-4xl mb-1 text-gree-600"/>
          <Icon icon="mdi:letter-b" className="text-4xl mb-1 text-gree-600"/>
          <Icon icon="mdi:letter-c" className="text-4xl mb-1 text-gree-600"/>
          <Icon icon="mdi:letter-d" className="text-4xl mb-1 text-gree-600"/>
          <Icon icon="mdi:letter-e" className="text-4xl mb-1 text-gree-600"/>
          <Icon icon="mdi:letter-f" className="text-4xl mb-1 text-gree-600"/>
      ...
      <table className="w-full">
        <tbody>
          <tr>
            ...
            <Textarea name="note.C" title="C" top  />
            <Textarea name="note.E" title="E" top right />
          </tr>
          <tr>
            <Textarea name="note.B" title="B" bottom left />
            <Textarea name="note.D" title="D" bottom />
